...
The second template is for the storage virtual machines and the HLS server. This image is based on a FreeBSD (v15) installation that has been adapted for jails.
